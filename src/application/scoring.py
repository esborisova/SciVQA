...
def main():
    ...
    references = [item["answer"] for item in gold_data]    
    predictions = pred_df["answer_pred"].tolist() 
    ...
    output_file.write("berS.f1: "+str(bert_score_f1)+"\n")
    print(f"berS.f1: {bert_score_f1}")
    output_file.write("berS.precision: "+str(bert_score_precision)+"\n")
    print(f"berS.precision: {bert_score_precision}")
    output_file.write("berS.recall: "+str(bert_score_recall)+"\n")
    print(f"berS.recall: {bert_score_recall}")
